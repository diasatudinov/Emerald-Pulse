...
struct ASGWV: UIViewRepresentable {
    let initialURL: URL
    ...
    class Coordinator: NSObject, WKNavigationDelegate {
        ...
        func webView(_ webView: WKWebView, didFinish navigation: WKNavigation!) {
            if let url = webView.url {
                ...
                if ASGLinks.shared.finalURL == nil {
                    ASGLinks.shared.finalURL = url
                }
    ...
    var body: some View {
        ZStack {
            if firstOpen {
                ...
                if let url = ASGLinks.shared.finalURL {
                    ASGWV(initialURL: url)
                        .onAppear {
